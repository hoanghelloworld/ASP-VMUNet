...
class setting_config_C2SDG:
    ...
    work_dir = 'results/' + datasets + '/' + network + '/' + datetime.now().strftime('%A_%d_%B_%Y_%Hh_%Mm_%Ss') + '/'
...
class setting_config_vmunet_v1:
...
class setting_config_VMUNetv2:
    ...
    model_config = {
        ...
        'drop_path_rate': 0.2,
        # 'load_ckpt_path': '/home/cheng/muyi/VM-UNetV2-main/results/vmunet_v2-v2_isic17_Friday_12_July_2024_14h_32m_32s',
        'load_ckpt_path': None,
